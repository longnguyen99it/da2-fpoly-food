...
public class AppConstant {
    ...
    public static final String LOGIN_FAILURE_MESSAGE = "Login failure";

    public static final String SUCCESSFUL_CODE = "00";
    public static final String SUCCESSFUL_MESAGE = "Successful";
    ...
    public static final String MY_EMAIL = "longnguyen99it@gmail.com";
    // Replace password!!
